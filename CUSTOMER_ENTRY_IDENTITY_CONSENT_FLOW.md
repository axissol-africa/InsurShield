...
| Protected quote request | Signed-in customer continues | Guest is redirected without losing stored vehicle details | `/create-account?next=/select-insurers` |
...
- `ProtectedQuoteRoute` is the gate for quote requests.
